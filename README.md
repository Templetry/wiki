...
**v1.0.0 and beyond (August 2026).** Engine **v1.10.1** (library + `templetry` CLI + `templetry-mcp` server), desktop **v1.11.0** (Windows, Linux, macOS), a catalog of **26 forms across 11 parents**, **12 form-local pieces and 2 common pieces** covering twelve ecosystems, all CI-verified.
