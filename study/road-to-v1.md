...
| G5 | ⏭️ **Soak window** — waived by owner decision ([ADR-0013](../adr/0013-declare-v1.md), 2026-08-07): the accumulated evidence (CI-verified catalog, fire test, update cycle in production use, zero breaking schema changes since validation) was judged a stronger signal than idle calendar time | waived | The only honest test of "the schema holds"; a change during the window resets it |
...
The expensive parts of a credible 1.0 — deterministic engine, validated schemas, CI-verified catalog, the full update cycle — already existed; the four engineering gates closed on 2026-08-07 and shipped as engine v0.3.0 + a complete catalog. What remained was calendar time, and the owner chose not to spend it: **v1.0.0 was declared the same day ([ADR-0013](../adr/0013-declare-v1.md)), waiving the soak window on the strength of the existing evidence.** The compatibility policy is in force; real use continues under it.
